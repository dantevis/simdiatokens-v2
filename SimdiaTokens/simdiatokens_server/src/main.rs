...
mod auth;
use auth::{register_handler, login_handler, me_handler, ensure_users_table, seed_default_admin, list_admins_handler, create_admin_handler, update_admin_handler, delete_admin_handler, sync_user_handler};
...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .route("/api/admin/sync-user", web::post().to(sync_user_handler))
